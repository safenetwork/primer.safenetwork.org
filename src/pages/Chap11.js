...
const component = () => (
    ...
    <div className='chapter'>
        ...
        <p><em>Node ageing</em> - only Nodes that have proved their worth over time (Elders) are allowed to vote on the validity of events in a Section. Nodes that do not pull their weight or act properly will be expelled and/or their Node Age reset to a lower value (see Chapter 5).</p>
