...
const component = () => (
    ...
    <div className='chapter'>
        ...
        <p>The Vaults that form the SAFE Network have different functions to fulfil. They route and store chunks of data. They cryptographically check messages and split into new Sections if theirs becomes too large. They also take on more defined roles which are called personas.</p>
