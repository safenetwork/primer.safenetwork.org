...
const Chap5 = () => (
    ...
    <div className='chapter'>
        ...
        <p>A Vault connects to other Vaults over the Crust layer, sending out a message that it wants to join the Network.</p>
        ...
        <p>Crust - a Rust library (&lsquo;Connections in Rust&rsquo;) maintained by MaidSafe that allows for NAT traversal, a technique of establishing and maintaining IP connections in P2P networks.</p>
        ...
        <p><a title="Crust" href="https://github.com/maidsafe/crust">Crust- Reliable p2p network connections in Rust with NAT traversal</a></p>
