...
<p>The Safe Network—and its underlying protocol—takes this further, automating the entire network of interconnected machines, making it autonomous, secure, and capable of storing, protecting and delivering data without any human involvement at all.</p>

<p>The Safe Network is the vision of MaidSafe, a Scottish software company working in the field of decentralized computer networking. It is an autonomous peer-to-peer network, created by linking together users’ computers and everyday connected devices, that’s designed to solve many of the current technical, managerial and societal problems exacerbated by centralized networks: a lack of privacy and data security, inefficiency and waste, censorship, and the massive consolidation of control by a few powerful actors.</p>
